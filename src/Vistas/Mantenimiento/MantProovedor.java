 ...
 * @author reant
 */
public class MantProovedor extends javax.swing.JFrame {

    /**
     * Creates new form Clientes
     */
    public MantProovedor() {
        initComponents();
        ActualizarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantProovedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantProovedor().setVisible(true);
            }
        });
    }
